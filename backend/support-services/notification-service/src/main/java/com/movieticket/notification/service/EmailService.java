...
public class EmailService {
    ...
    public boolean sendOrderSuccessfulEmail(OrderSuccessfulEvent event) {
        try {
            ...
            boolean isProductOnly = event.getSeatLabels() == null || event.getSeatLabels().isEmpty();

            if (isProductOnly) {
                helper.setSubject("🍿 Hóa đơn bắp nước / đồ lưu niệm #" + event.getOrderId() + " đã thanh toán thành công");
                String htmlContent = buildProductSuccessfulEmailHtml(event);
    ...
    private String buildProductSuccessfulEmailHtml(OrderSuccessfulEvent event) {
        List<OrderProductItem> productItems = event.getProductItems() == null
                ? Collections.emptyList()
                : event.getProductItems();
        ...
        html.append("<!DOCTYPE html>")
                ...
                // HEADER
                .append("<div style='background:#E50914;color:#fff;text-align:center;padding:20px;'>")
                .append("<h2 style='margin:0;'>🍿 ALPHA CINEMA</h2>")
                .append("<p style='margin:5px 0 0;font-size:13px;'>Hóa đơn dịch vụ & Quà tặng</p>")
                .append("</div>")
                ...
                .append("<h3 style='color:#E50914;margin-top:0;text-align:center;'>")
                .append("Cảm ơn bạn đã mua hàng tại Alpha Cinema!")
                .append("</h3>")

                .append("<table style='width:100%;font-size:14px;line-height:1.8;'>")

                .append("<tr><td><b>Mã đơn hàng:</b></td><td>")
                .append(event.getOrderId())
                .append("</td></tr>")

                .append("<tr><td><b>Địa điểm nhận:</b></td><td>")
                .append(nullToText(event.getCinemaName()))
                .append("</td></tr>")

                .append("<tr><td><b>Địa chỉ rạp:</b></td><td>")
                .append(nullToText(event.getCinemaAddress()))
                .append("</td></tr>")

                .append("<tr><td><b>Thời gian thanh toán:</b></td><td>")
                .append(event.getPaidAt() != null ? formatDateTime(event.getPaidAt()) : formatDateTime(LocalDateTime.now()))
                .append("</td></tr>")
                ...
                .append("<p style='font-size:18px;color:#E50914;'><b>Thanh toán:</b> ")
                .append(formatCurrency(event.getTotalPayment()))
                .append("</p>")
        ...
        // ĐỒ ĂN
        if (!productItems.isEmpty()) {
            html.append("<h4 style='margin-top:20px;color:#E50914;'>🍿 Danh sách sản phẩm</h4>")
                    .append("<table style='width:100%;border-collapse:collapse;font-size:13px;'>")
                    .append("<tr>")
                    .append("<th style='border:1px solid #ddd;padding:6px;'>Sản phẩm</th>")
                    .append("<th style='border:1px solid #ddd;padding:6px;'>SL</th>")
         ...
         // 2. Nhúng trực tiếp vào thẻ img
        html.append("<div style='text-align:center; margin-top:30px; padding:20px; background:#f9f9f9; border-radius:15px;'>")
                .append("<p style='margin:0 0 15px 0; color:#333; font-size:16px;'><b>Mã QR nhận hàng</b></p>")
                ...
                .append("<div style='margin-top:15px;'>")
                .append("<span style='display:block; font-size:12px; color:#888; text-transform:uppercase; letter-spacing:1px;'>Mã đơn hàng</span>")
                .append("<b style='font-size:14px; color:#E50914; font-family:monospace;'>").append(event.getOrderId()).append("</b>")
                .append("</div>")

                // Dòng ghi chú nhỏ
                .append("<p style='font-size:12px; color:#E50914; margin-top:10px; font-style:italic;'>* Vui lòng đưa mã này cho nhân viên tại quầy bắp nước/quà lưu niệm để nhận đồ</p>")
                .append("</div>")

                // FOOTER
                .append("<div style='background:#E50914;text-align:center;padding:15px;font-size:12px;color:#fff;margin-top:20px;'>")
                .append("Cảm ơn bạn đã lựa chọn Alpha Cinema! 🍿🥤<br/>Chúc bạn một ngày vui vẻ!")
                .append("</div>")
