...
import { PasswordFormField } from "@/pages/client/customer/profile/ProfileUIComponents";
...
const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({
  ...
  const mutation = useMutation({
    mutationFn: (data: any) => employeeService.changePassword(data),
    onSuccess: (res: any) => {
    ...
    <Modal isOpen={isOpen} onClose={handleClose} title="Chỉnh sửa mật khẩu">
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <PasswordFormField
          ...
          error={
            passwordErrors.passwordConfirm || passwordErrors.confirmPassword
          }
        />
        ...
        <div className="pt-4">
          <Button
            ...
            className="w-full bg-alpha-blue hover:bg-alpha-blue/90 text-white font-medium py-3 rounded-md shadow-lg shadow-orange-100 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
          >
            {mutation.isPending ? (
              <>
